  ...
  render() {
    ...
    return (
      <div className="topNav">
        ...
        <IconButton onClick={this.toggleDrawer('top', true)} anchor="top" className={classes.menuButton} classes={{colorInherit: classes.menuButton}} aria-label="Menu" elevation={3}>
            <MenuIcon />
        </IconButton>
        <Drawer
          anchor="top"
